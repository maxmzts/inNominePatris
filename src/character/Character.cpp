...
Character::Character() 
    ...
    if (!sprite.loadTexture("./src/resources/Character/South-idle.png")) {
    ...
    if (!shieldsprite.loadTexture("./src/resources/bubble.png")) {
    ...
    animationTextures = {
        {AnimationState::IDLE_DOWN, "./src/resources/Character/South-idle.png"},
        {AnimationState::IDLE_UP, "./src/resources/Character/North-idle.png"},
        {AnimationState::IDLE_LEFT, "./src/resources/Character/Left-idle.png"},
        {AnimationState::IDLE_RIGHT, "./src/resources/Character/Right-idle.png"},
        {AnimationState::WALK_DOWN, "./src/resources/Character/South-Run.png"},
        {AnimationState::WALK_UP, "./src/resources/Character/North-Run.png"},
        {AnimationState::WALK_LEFT, "./src/resources/Character/Left-Run.png"},
        {AnimationState::WALK_RIGHT, "./src/resources/Character/Right-Run.png"}
    };
...
void Character::drawHearts(GameEngine& engine) {
    ...
    static SpriteFacade heartSprite("./src/resources/crucifix.png");
